...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph edgemode="directed" edgeids="false" role="graph" id="start">
        ...
        <node id="n6">
            <attr name="layout">
                <string>331 148 27 33</string>
            </attr>
        </node>
        <node id="n21">
            <attr name="layout">
                <string>97 8 27 33</string>
            </attr>
        </node>
        <node id="n9">
            <attr name="layout">
        ...
        <edge to="n21" from="n0">
            ...
            <attr name="layout">
                <string>505 -1 199 35 290 35 12</string>
            </attr>
        </edge>
        <edge to="n17" from="n0">
            <attr name="label">
        ...
        <edge to="n19" from="n0">
            ...
            <attr name="layout">
                <string>472 -8 198 45 263 92 12</string>
            </attr>
        </edge>
        <edge to="n11" from="n11">
            <attr name="label">
