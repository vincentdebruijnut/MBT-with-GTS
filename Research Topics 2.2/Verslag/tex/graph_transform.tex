...
\begin{figure}[h]
  \begin{center}
    \subfloat[The start graph]{\label{fig:gg_graph}\input{./img/gg_graph.tex}}
    \subfloat[The LHS]{\label{fig:gg_lhs}\input{./img/gg_graph.tex}}\\
    \subfloat[The NAC]{\label{fig:gg_nac}\input{./img/gg_nac.tex}}
    \subfloat[The RHS]{\label{fig:gg_rhs}\input{./img/gg_rhs.tex}}
  \end{center}
