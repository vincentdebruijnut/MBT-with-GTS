...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph edgemode="directed" edgeids="false" role="graph" id="start">
        ...
        <node id="n0">
            <attr name="layout">
                <string>103 353 59 50</string>
            </attr>
        </node>
        <node id="n1">
            <attr name="layout">
                <string>62 439 70 37</string>
            </attr>
        </node>
        <node id="n2">
            <attr name="layout">
                <string>173 439 54 37</string>
            </attr>
        </node>
        <node id="n3">
            <attr name="layout">
                <string>309 352 59 50</string>
            </attr>
        </node>
        <node id="n4">
            <attr name="layout">
                <string>261 438 67 37</string>
            </attr>
        </node>
        <node id="n5">
            <attr name="layout">
                <string>375 435 54 37</string>
            </attr>
        </node>
        <node id="n7">
            <attr name="layout">
                <string>516 351 59 50</string>
            </attr>
        </node>
        <node id="n6">
            <attr name="layout">
                <string>469 437 66 37</string>
            </attr>
        </node>
        <node id="n8">
            <attr name="layout">
                <string>582 434 54 37</string>
            </attr>
        </node>
        <node id="n9">
            <attr name="layout">
                <string>36 26 91 50</string>
            </attr>
        </node>
        <node id="n10">
            <attr name="layout">
                <string>103 112 44 37</string>
            </attr>
        </node>
        <node id="n11">
            <attr name="layout">
                <string>170 25 91 50</string>
            </attr>
        </node>
        <node id="n12">
            <attr name="layout">
                <string>235 118 44 37</string>
            </attr>
        </node>
        <node id="n13">
            <attr name="layout">
                <string>293 27 91 50</string>
            </attr>
        </node>
        <node id="n14">
            <attr name="layout">
                <string>374 118 44 37</string>
            </attr>
        </node>
        <node id="n15">
            <attr name="layout">
                <string>19 108 30 37</string>
            </attr>
        </node>
        <node id="n16">
            <attr name="layout">
                <string>183 119 30 37</string>
            </attr>
        </node>
        <node id="n17">
            <attr name="layout">
                <string>299 109 30 37</string>
            </attr>
        </node>
        <edge to="n0" from="n0">
            <attr name="label">
