...
\begin{figure}[h]
  \begin{center}
    ...
    \subfloat[The throw rule]{\label{fig:example_groove_throw}\input{./img/throws.tikz}}\hspace{10px}
    \subfloat[The move rule]{\label{fig:example_groove_move}\input{./img/move.tikz}}\hspace{10px}
