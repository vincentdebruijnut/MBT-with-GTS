...
\begin{definition} Creator and eraser edges \\
...
\begin{figure}[ht]
  \begin{center}
    ...
    \subfloat[The $LHS$ of the $add$ rule]{\label{fig:priority_add_lhs}\input{./img/priority-example/add_lhs.tex}}\hspace{20px}
    \subfloat[The $RHS$ of the $add$ rule]{\label{fig:priority_add_rhs}\input{./img/priority-example/add_rhs.tex}}\\
    \subfloat[The $LHS$ of the $sub$ rule]{\label{fig:priority_sub_lhs}\input{./img/priority-example/sub_lhs.tex}}\hspace{20px}
