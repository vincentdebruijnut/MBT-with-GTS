...
Consider an STS $s$ and an LTS $l$. There exists a mapping from the location and location variable valuations to the states of $l$ and from the switch relations and variable valuations of $s$ to the transitions of $l$, such that $l$ is equivalent\marginpar{Is equivalent the correct term here?} to $s$. These relations defined as follows:
\begin{itemize}
