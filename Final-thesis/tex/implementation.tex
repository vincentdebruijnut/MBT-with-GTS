...
\begin{figure}[ht]
  \begin{center}
    \subfloat[The initial graph]{\label{fig:priority_start}\input{./img/start-priority.tikz}}\hspace{20px}
    \subfloat[The $sub$ rule with priority 0]{\label{fig:priority_sub}\input{./img/sub-priority.tikz}}\hspace{20px}
    \subfloat[The $add$ rule with priority 1]{\label{fig:priority_add}\input{./img/add-priority.tikz}}
  \end{center}
