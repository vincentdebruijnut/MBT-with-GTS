...
Make an interaction variable using $parin:$ node and control program $\mathit{alap} \{ \ggrule(n \in \mathbb{U}^\sort) | \mathit{other}\}$, where $\sort \in \Sorts$ is the sort of the interaction variable.
