...
The open source tools have not been extensively used in the business field. The problems described with testing in this chapter are from a business perspective. Therefore we prefer to use an industrial tool in this report if possible. Spec Explorer and ATM both are viable candidates. The choice was made to use ATM, because of the location of Axini and their willingness to support this project.
