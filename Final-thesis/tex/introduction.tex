...
The implementation described in chapter~\ref{chapter:implementation} upholds all three requirements; this is elaborated in chapter~\ref{chapter:conclusion}.
