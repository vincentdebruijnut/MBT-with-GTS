...
%\addsymbol \variableEdge: {A variable edge}{symbol:variableEdge}
\addsymbol \functionSymbol: {A function symbol}{symbol:FunctionSymbols}
\addsymbol \ltsLabel: {A label}{symbol:Labels}
\addsymbol \valueLabel: {A value label}{symbol:valueLabel}
\addsymbol \variableLabel: {A variable label}{symbol:variableLabel}
...
\addsymbol \variableAnchor: {A variable anchor}{symbol:variableAnchor}
