...
\begin{figure}
\centering
\subfloat[coffee machine]{\includegraphics[scale=0.10]{./figures/coffee_machine.jpg}}\hspace{10px}
\subfloat[graph]{\input{./figures/cm_simple_start.tikz}}
\end{figure}
\end{frame}
...
\begin{figure}
\centering
  \input{./figures/cm_simple_coin_match.tikz}
\end{figure}
\end{frame}
...
\begin{figure}
\centering
  \input{./figures/cm_simple_button_match.tikz}
\end{figure}
\end{frame}
...
\begin{figure}
\centering
  \input{./figures/cm_simple_coffee_match.tikz}
\end{figure}
\end{frame}
...
\begin{figure}
\centering
  \input{./figures/cm_simple_gts.tikz}
\end{figure}
\end{frame}
