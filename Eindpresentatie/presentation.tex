...
\end{block}
\begin{figure}
Plaatje IOLTS hier. %\input{./figures/atm.tikz}
\end{figure}
\end{frame}

\begin{frame}{Model-based Testing (3/3)}
\begin{figure}
Plaatje MBT hier. %\input{./figures/atm.tikz}
\end{figure}
\begin{enumerate}[<+->]
...
\begin{figure}
Plaatje graaf, een rule transition, en resultaat graaf hier. %\input{./figures/atm.tikz}
\end{figure}
\begin{itemize}[<+->]
...
\begin{figure}
Plaatje graph rule hier. %\input{./figures/atm.tikz}
\end{figure}
\begin{itemize}[<+->]
...
\end{itemize}
\begin{figure}
Plaatje STS hier. %\input{./figures/atm.tikz}
\end{figure}
\end{frame}
